...
import static csl.calcite.com.example.file.CsvEnumerator.deduceRowType;
...
public abstract class CsvTable extends AbstractTable {
  ...
  @Override public RelDataType getRowType(RelDataTypeFactory typeFactory) {
    ...
    if (rowType == null) {
      rowType = deduceRowType((JavaTypeFactory) typeFactory, source,
          null, isStream());
    }
    return rowType;
  }
  ...
  public List<CsvFieldType> getFieldTypes(RelDataTypeFactory typeFactory) {
    if (fieldTypes == null) {
      ...
      deduceRowType((JavaTypeFactory) typeFactory, source,
          fieldTypes, isStream());
    }
    return fieldTypes;
  }
